...
import { handleRemoveListing } from "utils/contracts/market";
      ...
      <Box sx={listModalStyle}>
        ...
        {selectedItemToRemove !== undefined && (
          <Button
            ...
            onClick={async (e: any) => {
              e.preventDefault();
              await handleRemoveListing(marketAddress, library, selectedItemToRemove._id);
              handleClose();
            }}>
            Remove NFT Listing
          </Button>
...
export default MarketRemoveModal;
